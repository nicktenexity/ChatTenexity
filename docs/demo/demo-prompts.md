...
- Report structure with audit-friendly assumptions.
...
- Workshop agenda.
- Stakeholder-specific question set.
- Decision log template.
- Deliverable checklist.

## File-Based Report Demo

Upload a PDF, spreadsheet, or Word document, then run:

```text
Turn this source file into a board-ready report. Extract the facts, identify missing assumptions, create a clean executive summary, add a risk table, and propose the next three decisions.
```
